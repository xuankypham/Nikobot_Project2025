...
<div>
  ...
  <table> <tr>
  <td>SocketServer: </td><td><input id= "ip" type="text"  placeholder="192.168.0.101" > </input> </td>
</tr>
<tr>
 <td> PORT:</td> <td><input id = "wsport" type="text"   value="81" placeholder="81"> </input> </td> 
  <input id="btws" type ="button" onclick="onconnect()" value="SETUP WEBSOCKET">  </input>
</tr>
<br> <hr>
<tr> </tr>
...
<p> reload data from controller</p>
<button onclick="getdata()"> RefreshMqtt</button>
</fieldset>
</div>
    <!-- --------------------------------------------------------->
<br>
...
<label id ="demo" hidden> Test Data</label>
<!--------------------------------------------------------------------------->
